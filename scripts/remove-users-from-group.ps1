...
.DESCRIPTION
    ...
    and removes users from the specified Entra ID groups.
    ...
    foreach ($UserRecord in $Users)
    {
        ...
        try
        {
            ...
            )
            {
                ...
                Write-Log `
                    "User [$Email] is not a member of [$GroupName]." `
                    "WARNING"
            ...
            if ($DryRun -eq "Yes")
            {
                ...
                Write-Log `
                    "[Dry Run] User [$Email] would be removed from [$GroupName]."
            ...
            Write-Log `
                "User [$Email] successfully removed from [$GroupName]." `
                "SUCCESS"
        }
        catch
        {
